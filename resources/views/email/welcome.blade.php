...
<body style="margin: 0; padding:0; width: 100%; background-color: #F2F4F6;">
 ...
 -->
      ...
      <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                               Hi {{$username}}, we’re glad you took out time to sign up at CampusCabal. Your account has been successfully created. Take a step into an entirely new world. Hop in the moving train, login today via {{url('/')}}.
                                            </p>
...
style="font-family: Arial, &#039;Helvetica &#039;, Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
   ...
   &copy; {{date('Y')}}
                                            <a style="color: #3869D4;" href="Campuscabal.com" target="_blank">CampusCabal</a>
                                            All rights reserved.
