...
style="font-family: Arial, &#039;Helvetica &#039;, Helvetica, sans-serif; display: block; display: inline-block; width: 200px; min-height: 20px;
 padding: 10px;
   ...
   text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;"
         ...
         <table style="margin-top: 25px; padding-top: 25px; border-top: 1px solid #EDEFF2;">
                                                <tr>
                                                    <td style="font-family: Arial, &#039;Helvetica &#039;, Helvetica, sans-serif;">
 ...
 clicking the "Reset Password" button,
                          ...
                          copy and paste the URL below into your web browser:
                                                    ...
                                                    <p style=3D"margin-top:=0; color: #74787E; font-size: 12px; line-height: 1.5em;">
              
                                              <a style="color: #3869D4;" href="{{$link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset())}}" target="_blank">
