...
<div class="row">
<h3 class="text-center top lead">{{\App\Institution::find($post->institution_id)->name}} Campus</h3>
<br/>
<div class="panel panel-default">
  <div class="panel-body">
    <div class="lead">Report Post</div>
    <p>Which of the rules was broken?</p>
     <form class="form-vertical" role="form" method="post" action="{{route('campuspost.report')}}" >
    <div class="checkbox">
  <label>
